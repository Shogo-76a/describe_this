...
export default class extends Controller {
  ...
  updateLayout() {
    if (this.isWideScreen) {
      ...
      this.wrapperGlobalTarget.classList.remove(
        'relative',
        'aspect-[600/400]',
        'overflow-hidden',
        'w-39/40',
      ...
      this.wrapperATarget.classList.remove(
        'absolute',
        'top-0',
        'left-0',
        'h-full',
      ...
      this.wrapperBTarget.classList.remove(
        'absolute',
        'top-0',
        'right-0',
        'h-full',
      ...
      this.wrapperGlobalTarget.classList.add(
        'relative',
        'aspect-[600/400]',
        'overflow-hidden',
      );
      this.wrapperATarget.classList.add(
        'absolute',
        'top-0',
        'left-0',
        'h-full',
      ...
      this.wrapperBTarget.classList.add(
        'absolute',
        'top-0',
        'right-0',
        'h-full',
  ...
  submitButtonTargetConnected(element) {
    ...
    console.log(
      `[Target接続] ボタンが新しく届きました。disabled: ${isDisabled}`,
    );
