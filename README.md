...
- 対AIであれば気楽に確認できると考えましたが、AIは使用者に話を合わせてくれるので、言葉を意図したイメージでAIが受け取ったのか、それともAIが不自然に合わせたのか疑心になり、意図通りに英語を使えているのか分からなくなりました。
- ということで、言葉を参考にAIに画像を作らせれば、自分のイメージとAIのイメージを直接比較できて疑問が晴れるのでは、と考えたのがきっかけです。
