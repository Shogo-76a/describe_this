...
- 英語学習を再開してから、実際に使えるのか確かめたくなった時に、 対人では緊張して英語そのものを満足に使えない自分には別の確認方法が必要だと感じました。
- 対AIであれば気楽に確認できると考えましたが、AIは使用者に話を合わせてくれるので、自分の言葉を、意図したイメージでAIが受け取ったのか、それとも不自然に合わせたのか疑心になり、自分は意図通りに英語を使えているのか分からなくなりました。
- ということで、言葉から受け取った内容でAIに画像を作らせれば、自分のイメージとAIのイメージを直接比較できて疑問が晴れるのでは、と考えたのがきっかけです。
